...
{foreach from=$params item=param key=param_key name=params}
	...
	<tr>
		<td width="100%">
		<img src="{devblocks_url}c=resource&p=portsensor.core&f=images/data_find.gif{/devblocks_url}" align="top">
	{/if}
	...
	{if !$nested}
		...
		<td width="0%" nowrap="nowrap" valign="top">
			{if !$batchDelete}
			<a href="javascript:;" onclick="document.{$view->id}_criteriaForm.field.value='{$param_key}';document.{$view->id}_criteriaForm.submit();"><img src="{devblocks_url}c=resource&p=portsensor.core&f=images/data_error.gif{/devblocks_url}" border="0" align="top"></a>
			{else}
