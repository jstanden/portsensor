...
<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      ...
      <td  valign="top" align="right">
      	<a href="http://www.portsensor.com/" target="_blank"><img alt="powered by portsensor" src="{devblocks_url}c=resource&p=portsensor.core&f=images/portsensor_logo_sm.gif{/devblocks_url}" border="0"></a>
      </td>
    </tr>
</table>
<br>
