	...
	<tr>
		<td colspan="2">
			{if $active_worker && $active_worker->is_superuser}
				<button type="button" onclick="genericAjaxPanel('c=setup&a=showWorkersBulkPanel&view_id={$view->id}&ids=' + Devblocks.getFormEnabledCheckboxValues('viewForm{$view->id}','row_id[]'),null,false,'500');"><img src="{devblocks_url}c=resource&p=portsensor.core&f=images/folder_gear.gif{/devblocks_url}" align="top"> bulk update</button>
			{/if}
		</td>
	</tr>
	{/if}
