<form>
	...
	{else}
	<button type="button" onclick="genericAjaxPanel('c=setup&a=showWorkerPeek&id=0&view_id={$view->id|escape:'url'}',this,false,'500px');"><img src="{devblocks_url}c=resource&p=portsensor.core&f=images/businessman_add.gif{/devblocks_url}" align="top"> Add Worker</button>
	{/if}
</form>
