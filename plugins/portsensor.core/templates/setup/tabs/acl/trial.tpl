<div class="block">
<h3>This professional feature is disabled in the free version.  The following worker permissions are configurable with a <a href="http://www.portsensor.com/buy" target="_blank">purchased license</a>:</h3>
<br>
