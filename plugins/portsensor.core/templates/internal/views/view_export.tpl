...
<br>
<button type="button" onclick="this.form.submit();" style=""><img src="{devblocks_url}c=resource&p=portsensor.core&f=images/check.gif{/devblocks_url}" border="0" align="top"> {$translate->_('common.export')|capitalize}</button>
<button type="button" onclick="toggleDiv('{$view_id}_tips','none');clearDiv('{$view_id}_tips');" style=""><img src="{devblocks_url}c=resource&p=portsensor.core&f=images/delete.gif{/devblocks_url}" align="top"> Cancel</button>
